...
import { upadateuserAction } from "../../redux/actions/userActions";
...
function Profile() {
  ...
  useEffect(() => {
    ...
    if (updated) {
      router.push("/");
      dispatch({ type: userTypes.UPDATE_PROFILE_RESET });
    }
  }, [dispatch, updated, error, loadedUser]);
  ...
  const submitHandler = (e) => {
    ...
    dispatch(upadateuserAction(userData));
  };
          ...
          <div className="row wrapper">
            <div className="col-10 col-lg-5">
              <form className="shadow-lg" onSubmit={submitHandler}>
                ...
                >
                  {updateLoading ? <LoadButton /> : "UPDATE"}
                </button>
              </form>
            </div>
          </div>
